  ...
  <div>
    <el-form ref="form" :model="form" label-width="100px" label-position="top">
      <div class="block">
        ...
        <div class="mt-4">
          <el-form-item class="inline-block" label="分数:" :rules="rule.input" prop="score">
            <el-input
              class="input"
              type="number"
              v-model="form.score"
          ...
          <el-form-item class="inline-block" label="评审等次:" prop="grade">
            <el-input class="input" v-model="form.grade" disabled placeholder="自动计算" />
          </el-form-item>
          <el-form-item label="规划评审意见：" :rules="rule.input" prop="suggestion">
