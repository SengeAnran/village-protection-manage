  ...
  <div>
    ...
    <div class="block">
      ...
      <el-form style="padding-left: 14px" ref="form" class="form" label-position="top" :model="form" label-width="80px">
        ...
        <div class="input-item-wrp">
          <el-form-item :label="item.label" v-for="(item, i) in historyBuildings" :key="i">
            <p class="content">{{ form[item.value] }}</p>
          </el-form-item>

          <el-form-item v-if="form.villageType" label="其中属历史建筑数量">
    ...
    <el-dialog title="审核" :visible.sync="dialogVisible" width="600px">
      <el-form>
        <el-form-item label="">
          <el-radio v-model="status" label="1">通过</el-radio>
          <el-radio v-model="status" label="0">不通过</el-radio>
...
import { getVillageItemDetail, getvillageDetailExport, provinceVerify } from '@/api/villageManage';
