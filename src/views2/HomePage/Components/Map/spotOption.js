...
import opint from './opint.png';
export function getSpotOption(data, map) {
...
export function getSpotOption2(data, map) {
  // const maxSize4Pin = 36;
  // const minSize4Pin = 26;
  // const maxFontSize = 16;
  // const minFontSize = 11;
  ...
  return {
    ...
    series: [
      ...
      },
      {
        ...
        tooltip: {
          formatter: function (obj) {
            return ` <div style="font-weight: bold">${obj.name}</div>`;
          },
        },
      },
    ],
